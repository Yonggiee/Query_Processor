...
public class QueryMain {
     ...
     **/
    private static void configureBufferManager(int numJoin, int numOrderBy, int numAggregate, String[] args, BufferedReader in) {
        if (numJoin != 0 || numOrderBy != 0 || numAggregate != 0) {
            int numBuff = 1000;
            if (args.length < 4) {
